...
* [Notes from Feb 2023 lab discussion about co-authorship](https://docs.google.com/document/d/15BIKwQJo0o95GjHeVtOrqfHjCH6zmnYC/edit)
...
* [Elsevier journal explanation of CRediT authorship system ](https://www.elsevier.com/authors/policies-and-guidelines/credit-author-statement)

* [Another useful elsevier guide on authorship](https://www.elsevier.com/__data/promis_misc/RESINV_GfA.pdf)
...
During these conferences, you are typically eligible for a per diem (up to $100 CAD or $80 USD per day). You should track the days you are away and submit an expense report to get reimbursed. To do so, visit the [workday portal](https://hr.ubc.ca/working-ubc/welcome-workday). From there, click on 'Expenses' in the main menu, and submit a report. If you have any other questions, you can email [Gladys Tecson](https://frm.forestry.ubc.ca/people/staff/) (`gladys.tecson@ubc.ca`). It takes a little while to be processed, but you will be reimbursed.
